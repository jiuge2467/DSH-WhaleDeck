...
export const zh = {
  ...
  'delete.session.desc': '将永久删除会话“{name}”及其所有历史记录。此操作不可恢复。',
  'delete.session.pending': '正在删除会话…',
  'delete.session.confirm': '确认删除',
  'menu.fork': '分叉会话',
...
export const en = {
  ...
  'delete.session.desc': 'Permanently delete “{name}” and all its history? This action cannot be undone.',
