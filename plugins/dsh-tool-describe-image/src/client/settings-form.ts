...
/** A secret field whose literal is not echoed back. An empty draft is ignored. */
...
export class CardForm<T> {
  ...
  private readonly secretFields: Set<string>
  ...
  constructor(
    ...
    this.secretFields = new Set(secretFields)
